...
const yamlData = yaml.parse(`name: 🐛 Bug Report
description: Report a software bug on this repository.
title: "[Bug]"
# assignees:
labels:
  - bug
body:
  ...
  - type: textarea
    ...
    attributes:
      label: Code Sample
      description: "Please provide a code repository, gist, code snippet or sample files to reproduce the issue."
      value: ""
      render: bash
    validations:
      required: true
